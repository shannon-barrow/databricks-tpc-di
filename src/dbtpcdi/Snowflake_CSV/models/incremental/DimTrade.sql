...
WITH tradeincremental as (
    select
        ...
        $9::int       as quantity,
        $10::double   as bidprice,
        $11::bigint   as t_ca_id,
        $12::string   as executedby,
        $13::double   as tradeprice,
        $14::double   as fee,
        $15::double   as commission,
        $16::double   as tax,
    ...
    from
      ...
      (
        ...
        PATTERN     => '.*Batch[23]/Trade[.]txt'
      ) t
),
tradehistoryraw as (
    select
        $1::bigint    as tradeid,
        $2::timestamp as th_dts,
        $3::string    as status
    from
        @{{ var('stage') }}/Batch1
        (
...
tradehistory as (
    select
        $1::bigint    as t_id,
        $2::timestamp as t_dts,
        $3::string    as t_st_id,
        $4::string    as t_tt_id,
        $5::tinyint   as t_is_cash,
        $6::string    as t_s_symb,
        $7::int       as quantity,
        $8::double    as bidprice,
        $9::bigint    as t_ca_id,
        $10::string   as executedby,
        $11::double   as tradeprice,
        $12::double   as fee,
        $13::double   as commission,
        $14::double   as tax
    from
        @{{ var('stage') }}/Batch1
        (
