...
_BRONZE_TABLES_JSON = (
    ...
    '{"table": "finwire", "filename": "{FINWIRE[0-9][0-9][0-9][0-9]Q[1-4],FINWIRE_[0-9]*.txt}", "raw_schema": "value STRING COMMENT \'Pre-parsed String Values of all FinWire files\'", "part": "rectype", "add_tgt_schema": ", rectype STRING COMMENT \'Indicates the type of table into which this record will eventually be parsed: CMP FIN or SEC\'", "tgt_query": "*, substring(value, 16, 3) rectype"}]'
)
