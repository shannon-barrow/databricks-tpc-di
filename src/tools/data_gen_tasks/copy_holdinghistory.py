...
# MAGIC %md
# MAGIC # data_gen task: copy_holdinghistory (standard mode)
# MAGIC
# MAGIC Copies HoldingHistory.txt staging → final across Batch1/2/3.
...
n = copy_dataset(cfg=ctx["cfg"], dbutils=dbutils, filenames=["HoldingHistory.txt"])
print(f"[copy_holdinghistory] {n} files copied")
