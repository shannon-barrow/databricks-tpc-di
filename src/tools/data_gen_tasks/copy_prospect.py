...
# MAGIC %md
# MAGIC # data_gen task: copy_prospect (standard mode)
# MAGIC
# MAGIC Copies Prospect.csv staging → final across Batch1/2/3. Augmented
# MAGIC mode skips prospect generation entirely so this self-skips.
