...
# MAGIC %md
# MAGIC # data_gen task: copy_watch_history (standard mode)
# MAGIC
# MAGIC Copies WatchHistory.txt staging → final across Batch1/2/3. Augmented
# MAGIC mode self-skips (gen_watch_history writes Delta).
...
n = copy_dataset(cfg=ctx["cfg"], dbutils=dbutils, filenames=["WatchHistory.txt"])
print(f"[copy_watch_history] {n} files copied")
