...
# MAGIC %md
# MAGIC # data_gen task: copy_daily_market (standard mode)
# MAGIC
# MAGIC Copies DailyMarket.txt staging → final across Batch1/2/3. Augmented
# MAGIC mode self-skips (gen_daily_market writes Delta).
...
n = copy_dataset(cfg=ctx["cfg"], dbutils=dbutils, filenames=["DailyMarket.txt"])
print(f"[copy_daily_market] {n} files copied")
