...
CREATE OR REPLACE TABLE ${catalog}.${wh_db}.FactHoldings (
  ...
  sk_dateid BIGINT NOT NULL COMMENT 'Surrogate key for the date associated with the',
  sk_timeid BIGINT NOT NULL COMMENT 'Surrogate key for the time associated with the',
