...
-- CREATE WIDGET DROPDOWN tbl DEFAULT "DimDate" CHOICES SELECT * FROM (VALUES ("AccountIncremental"), (("DimDate"), ("DimTime"), ("HoldingIncremental"), ("Industry"), ("StatusType"), ("TaxRate"), ("TradeType"), ("WatchIncremental"));
