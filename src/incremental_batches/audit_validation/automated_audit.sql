...
CREATE OR REPLACE TABLE automated_audit_results as
select
  *
from
  (
    ...
    select
      ...
      'There must be audit data for all data sets' as Description -- Checks against the DImessages table.
    union all
    select
    ...
    select
      ...
      'All DW tables must be empty before Batch1' -- Checks against the DimBroker table.
    union all
    select
      'DimBroker row count',
      NULL,
    ...
    select
      ...
      'Actual row count matches or exceeds Audit table minimum' -- had to change to sum(value) instead of just value because of correlated subquery issue
    union all
    select
      'DimAccount row count',
      BatchID,
    ...
    select
      ...
      'All SKs are distinct' -- Three tests together check for validity of the EffectiveDate and EndDate handling:
    ...
    union all
      ...
      --                   where BatchID = a.BatchID and (
      --                         EffectiveDate < (select Date from Audit a where DataSet = 'Batch' and Attribute = 'FirstDay' and BatchID = a.BatchID) or
      --                         EffectiveDate > (select Date from Audit a where DataSet = 'Batch' and Attribute = 'LastDay' and BatchID = a.BatchID) )
      --             ) = 0
      ...
      case
        when (
          ...
          from
            DimCustomer
          where
            Phone1 not like '+1 (___) ___-____%'
      ...
      case
        when (
          ...
          from
            DimCustomer
          where
            Phone2 not like '+1 (___) ___-____%'
      ...
      case
        when (
          ...
          from
            DimCustomer
          where
            Phone3 not like '+1 (___) ___-____%'
    ...
    select
      ...
      case
        ...
        and (
          select
            count(distinct LocalTaxRateDesc)
          from
            DimCustomer
        ) > 300 then 'OK'
        else 'Mismatch'
      end,
      'LocalTaxRateDesc and LocalTaxRate values are from TaxRate table'
    union all
    select
      ...
      case
        ...
        and (
          select
            count(distinct NationalTaxRateDesc)
          from
            DimCustomer
      ...
      'NationalTaxRateDesc and NationalTaxRate values are from TaxRate table'
    union all
    select
      ...
      case
        when (
          ...
          from
            DimSecurity
          where
            ExchangeID not in ('NYSE', 'NASDAQ', 'AMEX', 'PCX')
        ) = 0 then 'OK'
      ...
      case
        when (
          ...
          from
            DimSecurity
          where
            Issue not in ('COMMON', 'PREF_A', 'PREF_B', 'PREF_C', 'PREF_D')
        ) = 0 then 'OK'
        else 'Bad value - see ticket #65'
      end,
      ...
      case
        when (
          ...
          from
            DimCompany
          where
            Country not in ('Canada', 'United States of America', '')
      ...
      case
        when (
          ...
          from
            Prospect
          where
            SK_RecordDateID < SK_UpdateDateID
        ) = 0 then 'OK'
        else 'Mismatch'
      end,
            ...
            case
              when (
                ...
                from
                  ...
                  and Attribute = 'FirstDay'
                  and DateValue < Date
                  and P.BatchID = _A.BatchID --                where p.BatchID = a.BatchID and (
      ...
      case
        when (
          ...
          from
            Prospect
          where
            Country not in ('Canada', 'United States of America') -- For the tiny sample data it would be ( 'CANADA', 'USA' )
            and Country is not null
        ) = 0 then 'OK'
        else 'Bad value'
      end,
            ...
            sum(
              ...
              case
                when COALESCE(MarketingNameplate, '') not in (
                  ...
                  'HighValue+Boomer',
                  'Expenses+Boomer',
                  'HighValue+Expenses+Boomer',
                  'MoneyAlert',
                  'HighValue+MoneyAlert',
                  'Expenses+MoneyAlert',
                  'HighValue+Expenses+MoneyAlert',
                  'Boomer+MoneyAlert',
                  'HighValue+Boomer+MoneyAlert',
                  'Expenses+Boomer+MoneyAlert',
                  'HighValue+Expenses+Boomer+MoneyAlert',
                  'Spender',
                  'HighValue+Spender',
                  'Expenses+Spender',
                  'HighValue+Expenses+Spender',
                  'Boomer+Spender',
                  'HighValue+Boomer+Spender',
                  'Expenses+Boomer+Spender',
                  'HighValue+Expenses+Boomer+Spender',
                  'MoneyAlert+Spender',
                  'HighValue+MoneyAlert+Spender',
                  'Expenses+MoneyAlert+Spender',
                  'HighValue+Expenses+MoneyAlert+Spender',
                  'Boomer+MoneyAlert+Spender',
                  'HighValue+Boomer+MoneyAlert+Spender',
                  'Expenses+Boomer+MoneyAlert+Spender',
                  'HighValue+Expenses+Boomer+MoneyAlert+Spender',
                  'Inherited',
                  'HighValue+Inherited',
                  'Expenses+Inherited',
                  'HighValue+Expenses+Inherited',
                  'Boomer+Inherited',
                  'HighValue+Boomer+Inherited',
                  'Expenses+Boomer+Inherited',
                  'HighValue+Expenses+Boomer+Inherited',
                  'MoneyAlert+Inherited',
                  'HighValue+MoneyAlert+Inherited',
                  'Expenses+MoneyAlert+Inherited',
                  'HighValue+Expenses+MoneyAlert+Inherited',
                  'Boomer+MoneyAlert+Inherited',
                  'HighValue+Boomer+MoneyAlert+Inherited',
                  'Expenses+Boomer+MoneyAlert+Inherited',
                  'HighValue+Expenses+Boomer+MoneyAlert+Inherited',
                  'Spender+Inherited',
                  'HighValue+Spender+Inherited',
                  'Expenses+Spender+Inherited',
                  'HighValue+Expenses+Spender+Inherited',
                  'Boomer+Spender+Inherited',
                  'HighValue+Boomer+Spender+Inherited',
                  'Expenses+Boomer+Spender+Inherited',
                  'HighValue+Expenses+Boomer+Spender+Inherited',
                  'MoneyAlert+Spender+Inherited',
                  'HighValue+MoneyAlert+Spender+Inherited',
                  'Expenses+MoneyAlert+Spender+Inherited',
                  'HighValue+Expenses+MoneyAlert+Spender+Inherited',
                  'Boomer+MoneyAlert+Spender+Inherited',
                  'HighValue+Boomer+MoneyAlert+Spender+Inherited',
                  'Expenses+Boomer+MoneyAlert+Spender+Inherited',
                  'HighValue+Expenses+Boomer+MoneyAlert+Spender+Inherited'
                ) then 1
                else 0
              end
            )
      ...
      (
        select
          ...
          case
            when (
              select
                cast(sum(MessageData) as bigint)
              from
                DImessages
              where
                MessageSource = 'FactWatches'
                    ...
                    and (
                      (
                        ...
                        from
                          DimDate
                        where
                          SK_DateID = w.SK_DateID_DatePlaced
                      ) > (
                        select
                          first(Date)
                        from
                    ...
                    and (
                      (
                        ...
                        from
                          DimDate
                        where
                          SK_DateID = w.SK_DateID_DateRemoved
                      ) > (
                        select
                          first(Date)
                        from
      ...
      case
        when (
          ...
          from
            Financial
          where
            Round(FI_NET_EARN / FI_OUT_BASIC, 2) - FI_BASIC_EPS not between -0.4
            and 0.4
              ...
              cast(
                (
                  ...
                  from
                    DImessages
                  where
                    MessageSource = 'FactMarketHistory'
                    and MessageType = 'Validation'
                    and MessageText = 'Row count'
                    and BatchID = a.BatchID
                ) as int
    ...
    select
      ...
      'All SK_AccountIDs match a DimAccount record with a valid date range' --good till here
    union all
    select
