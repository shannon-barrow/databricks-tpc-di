...
# Branch: FactCashBalances.
#
# Thread A: COPY bronzecashtransaction (direct dep).
# Thread B: COPY bronzecustomer; COPY bronzeaccount; ALTER REFRESH dimaccount.
#           dimaccount's REFRESH cascades DOWNSTREAM through AUFC + dimcustomer.
# Converge → ALTER REFRESH factcashbalances.
...
results = run_branch(
    ...
    sf_connect_kwargs=dict(
        ...
        secret_catalog=secret_catalog, secret_schema=secret_schema,
        warehouse=warehouse,
    ),
    ...
    query_tag_base={
        ...
        "task":         "branch_factcashbalances",
    },
    independent_bronze="bronzecashtransaction",
    chain_bronzes=["bronzecustomer", "bronzeaccount"],
    chain_dim_refresh="dimaccount",
    leaf_dt="factcashbalances",
)
