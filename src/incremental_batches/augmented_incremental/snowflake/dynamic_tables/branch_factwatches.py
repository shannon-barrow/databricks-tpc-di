...
# Branch: FactWatches.
#
# Thread A: COPY bronzewatches (direct dep).
# Thread B: COPY bronzecustomer; ALTER REFRESH dimcustomer (the dim chain
#           feeding factwatches via dimcustomer).
# Converge → ALTER REFRESH factwatches.
...
results = run_branch(
    ...
    query_tag_base={
        ...
        "task":         "branch_factwatches",
    },
    independent_bronze="bronzewatches",
    chain_bronzes=["bronzecustomer"],
    chain_dim_refresh="dimcustomer",
    leaf_dt="factwatches",
)
