...
CLUSTER BY (accountid)  -- liquid: business key. Daily SCD2 updates hit a random subset of accounts scattered across the accountid range, fragmenting the layout so PO/auto-clustering has continuous recluster work; matches the realistic "account X history" BI filter. (Was enddate.)
TBLPROPERTIES (
